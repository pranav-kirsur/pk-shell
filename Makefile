CFLAGS = -g -Wall
OBJECTS = main.o prompt.o init.o loop.o parse.o execute.o exec_pwd.o exec_cd.o exec_echo.o exec_ls.o
...
execute.o : execute.h execute.c exec_pwd.h exec_cd.h exec_echo.h exec_ls.h
