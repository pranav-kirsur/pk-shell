CFLAGS = -g -Wall
OBJECTS = main.o prompt.o init.o loop.o parse.o execute.o exec_pwd.o exec_cd.o exec_echo.o exec_ls.o launch.o exec_pinfo.o bg_terminate.o history.o nightswatch.o countargs.o exec_setenv.o exec_unsetenv.o linkedlist.o exec_jobs.o exec_kjob.o exec_fg.o exec_bg.o
...
execute.o : execute.h execute.c exec_pwd.h exec_cd.h exec_echo.h exec_ls.h launch.h exec_pinfo.h history.h nightswatch.h exec_setenv.h exec_unsetenv.h exec_jobs.h exec_kjob.h exec_fg.h exec_bg.h
